...
void setup() {
    ...
    setupMpu();
    setupLaser();
    sprintf(ap_ssid, "REN_%08X", ESP.getChipId());
        ...
        case WStype_TEXT:
            ...
            if (payload[0] == '#') {
                if(payload[1] == 'C') {
                  ...
                  forward();
                  Serial.println ("Moving Forward."); //printout the movement for python code to fetch and compare
                }
                else if(payload[1] == 'B'){ 
                  backward();
                  Serial.println ("Moving Backward."); //printout the movement for python code to fetch and compare
                }
                else if(payload[1] == 'L'){
                  left();
                  Serial.println ("Moving Left."); //printout the movement for python code to fetch and compare
                }
                else if(payload[1] == 'R'){
                  right();
                  Serial.println ("Moving Right."); //printout the movement for python code to fetch and compare
                }
                else if(payload[1] == 'U') {
                  if(payload[2] == 'L') 
                    servo_left_ctr -= 1;
